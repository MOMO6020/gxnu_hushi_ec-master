...
//define chassis_rl_id = 1;

ErrorCode DMMotor::sendControlCommand(DMMotor::ControlCommand command)      //错误反馈，，
{
...
///////////////////////////////////////////////////////////////////
    setMITControlPacket( // 5. 发送控制指令（将PID输出转换为达妙电机协议）
        target_angle_ * DEGREE_TO_RADIAN,  // 目标位置（弧度）
        0,  // 速度指令（位置控制时可设为0）
        pid_ref,  // 扭矩指令（由PID计算得到）
        5, 0.1  // Kp和Kd参数（根据调试优化）
    );
